...
### 20.3 按分类 PASS 率（最终统一口径）

| RQ | CONC (8) | FS (8) | DISP (8) | ANOM (1) | 无分类 (1) | **全 26** |
|:-:|:-:|:-:|:-:|:-:|:-:|:-:|
| RQ1 | 8/8 | 8/8 | 8/8 | 1/1 | 1/1 | **26/26 (100%)** |
| RQ2a | 7/8 | 6/8 | 7/8 | 0/1 | 1/1 | **21/26 (81%)** |
| RQ3 | 8/8 | 7/8 | 8/8 | 1/1 | 0/1 | **24/26 (92%)** |
| RQ4 | 4/8 | 6/8 | 4/8 | 0/1 | 0/1 | **14/26 (54%)** |
| RQ5 | 6/8 | 6/8 | 4/8 | 0/1 | 1/1 | **17/26 (65%)** |
| RQ6 | 1/8 | 1/8 | 0/8 | 0/1 | 0/1 | **2/26 (8%)** |
...
| **RQ4** | CONC: R² ≥ 0.7 AND σ₁ ≥ 3 / 多层: macro σ₁ ≥ 10³ AND ΔMA ≤ -80% | **分类依赖**：单层看 SVD 拟合，多层看 macro |
| **RQ5** | CONC: 单层 V 消融 ΔMA ≤ -80% / 多层: macro V 消融 ΔMA ≤ -80% | **分类依赖**：单层 V 消融 vs macro V 消融 |
| RQ6 | recovery ≥ 30%（全 26 统一）| 保留单层后 MA 恢复率 |
...
> - RQ1/RQ2a/RQ3 三个基础结论 **≥ 81% PASS**
> - RQ4/RQ5 公式 + 因果验证（按分类判据）**54%-65% PASS**
> - RQ6 单独定位为"MLP + residual stream 协作"补充论证
