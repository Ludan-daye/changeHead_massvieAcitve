...
def get_mlp_weights(layer):
    ...
    raise ValueError("Cannot find down_proj")

# LLaMA2-13B: MA层是Layer 22，选择代表性层
layer_ids = [0, 1, 2, 3, 10, 20, 22, 38, 39]

print("="*80)
print("EXPERIMENT 4: LLaMA2-13B MLP SVD Analysis")
...
# 保存结果
savedir = os.path.join(PROJECT_ROOT, 'results/experiments/exp4/llama2_13b')
...
print(f"\n{'='*80}")
print(f"✅ LLaMA2-13B完成！结果已保存至: {output_path}")
print(f"{'='*80}")
