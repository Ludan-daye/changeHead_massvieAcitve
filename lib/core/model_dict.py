...
MODEL_DICT_LLMs = {
    ### ============ Newly downloaded models (local paths) ============ ###

    # Qwen2.5-7B (GQA architecture)
    "qwen2.5_7b": {
        "model_id": f"{LOCAL_MODELS_DIR}/Qwen2.5-7B",
        "cache_dir": None,  # Local models do not need cache
    },
    ...
    # BLOOM-7B1 (ALiBi positional encoding)
    "bloom_7b1": {
    ...
    ### ============ Original models (HuggingFace cache) ============ ###
    ### llama2 model
    "llama2_7b": {
        "model_id": "meta-llama/Llama-2-7b-hf",
        "cache_dir": CACHE_DIR_BASE
    },
    "llma2b": {  # Alias for llama2_7b
        "model_id": "meta-llama/Llama-2-7b-hf",
        "cache_dir": CACHE_DIR_BASE
    },
    "llama2_13b": {
