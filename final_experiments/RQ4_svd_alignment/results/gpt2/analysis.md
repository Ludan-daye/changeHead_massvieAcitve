...
- **起源层 L** = 3
- **σ₁** = 40.803091923934794
- **σ₁/σ₂ 比** = 3.05141038484784
- **R² (K=1 公式拟合)** = 0.5506723264216654
- **slope β** = 25.647438467985445
- **intercept b** = 4.953678179305064
- **max|proj_F|** = 3.9858914960420195
- **max|MA_F|** = 165.875

**判据**：K=1 R² ≥ 0.95 OR macro V 消融 ΔMA ≤ -80%（任一即 PASS） — **✅ macro -95%**
