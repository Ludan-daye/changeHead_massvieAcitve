...
class SVDSpaceAnalyzer:
    ...
    def __init__(self, W2, tracker, keep_top_k=100):
        """
        Args:
            W2: Down-projection matrix [intermediate_size, hidden_size]
...
def main():
    ...
    parser.add_argument('--model', type=str, default='gpt2', help='Model name (see lib/model_dict.py)')
    ...
    if mlp_parts['is_gated']:
        ...
        gelu_hook = mlp_parts['activation'].register_forward_hook(capture_h2_hook)
